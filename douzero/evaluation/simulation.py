...
def evaluate(landlord, landlord_up, landlord_down, eval_data, num_workers, output, output_bid, title,id,frames):
    ...
    # print('WP results:')
    print('{} : {}'.format(num_landlord_wins / num_total_wins, num_farmer_wins / num_total_wins))
    # print('ADP results:')
    ...
    #     with open("test.txt","a",encoding="utf-8") as f:
    #         f.writelines(str)
    #     csvdata=[frames,'{}'.format(num_landlord_wins / num_total_wins),'{}'.format(num_farmer_wins / num_total_wins)]
    #     csvFile = open(id, "a",newline='')
    #     # 新建对象writer
    ...
    # else:
    #     str = ['{} : {}\n'.format(num_landlord_wins / num_total_wins, num_farmer_wins / num_total_wins)]
    #     with open("ADP.txt", "a", encoding="utf-8") as f:
    #         f.writelines(str)
